...
/**
 * A command that drives the robot backward for the given time at the given
 * speed
 * 
...
public class DriveBackward extends Command {
	 ...
	 * 
	 * @param speed
	 *            the speed at which to drive backward at
	 * @param duration
	 *            how long to drive backward. Precondition: the speed must be
	 *            0<speed<1 inclusive and duration must be greater than zero.
